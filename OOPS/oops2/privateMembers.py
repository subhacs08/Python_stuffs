...
class Studentchild(Student):
    ...
    def __init__(self):
        ...
        print(self._Student__name)  # Just to check if name is John as we assigned just above


def mainprivatemembers():
        student1 = Student(name="James", batchId=3, universityName="MIT")
        # can't use __name directly outside class, so using name mangling and making indirect access of private variables
